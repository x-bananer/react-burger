import { ADD_INGREDIENT, REMOVE_INGREDIENT, MOVE_INGREDIENT, CLEAR_CONSTRUCTOR } from '../actions/constructor';
    ...
    switch (action.type) {
        case ADD_INGREDIENT: {
            ...
            if (ingredient.type === 'bun') {
                const withoutBun = state.items.filter((i: Ingredient) => i.type !== 'bun');
                return {
                    ...state,
        ...
        case REMOVE_INGREDIENT: {
            return {
                ...state,
                items: state.items.filter((ingredient: Ingredient) => ingredient.uid !== action.payload)
            };
        }
        case MOVE_INGREDIENT: {
            ...
            const fillings = state.items.filter((i: Ingredient) => i.type !== 'bun');
